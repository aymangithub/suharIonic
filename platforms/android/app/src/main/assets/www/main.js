...
var map = {
	...
	"./gdnanlky.sc.entry.js": [
		"./node_modules/@ionic/core/dist/esm/es5/build/gdnanlky.sc.entry.js",
		"common",
		83
	],
	"./ghnjhuec.entry.js": [
		"./node_modules/@ionic/core/dist/esm/es5/build/ghnjhuec.entry.js",
		0,
		"common",
		146
	],
	"./ghnjhuec.sc.entry.js": [
		"./node_modules/@ionic/core/dist/esm/es5/build/ghnjhuec.sc.entry.js",
		0,
		"common",
		147
	],
	...
	"./u6rzl46l.entry.js": [
		"./node_modules/@ionic/core/dist/esm/es5/build/u6rzl46l.entry.js",
		0,
		"common",
		158
	],
	"./u6rzl46l.sc.entry.js": [
		"./node_modules/@ionic/core/dist/esm/es5/build/u6rzl46l.sc.entry.js",
		0,
		"common",
		159
	],
...
var map = {
	...
	"../account/blog/blog.module": [
		"./src/app/account/blog/blog.module.ts",
		"common",
		"account-blog-blog-module"
	],
	"../account/blogs/blogs.module": [
		"./src/app/account/blogs/blogs.module.ts",
		"common",
		"account-blogs-blogs-module"
	],
	"../account/edit-address/edit-address.module": [
		"./src/app/account/edit-address/edit-address.module.ts",
		"account-edit-address-edit-address-module"
	],
	"../account/forgotten/forgotten.module": [
	...
	"../account/orders/orders.module": [
		"./src/app/account/orders/orders.module.ts",
		"account-orders-orders-module"
	],
	"../account/points/points.module": [
	...
	"../account/setting/setting.module": [
		"./src/app/account/setting/setting.module.ts",
		"account-setting-setting-module"
	],
	"../account/wallet/wallet.module": [
		"./src/app/account/wallet/wallet.module.ts",
		"account-wallet-wallet-module"
	],
	"../account/wishlist/wishlist.module": [
	...
	"../checkout/address/address.module": [
		"./src/app/checkout/address/address.module.ts",
		"common",
		"checkout-address-address-module"
	],
	"../checkout/checkout/checkout.module": [
	...
	"./checkout/order-summary/order-summary.module": [
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getBlocks = function () {
        var url = this.config.url + "/wp-admin/admin-ajax.php?action=mstoreapp-keys";
    ...
    ApiService.prototype.getItem = function (endPoint, filter) {
    ...
    ApiService.prototype.deleteItem = function (endPoint, id) {
    ...
    ApiService.prototype.postItem = function (endPoint, data) {
        if (data === void 0) { data = {}; }
    ...
    ApiService.prototype.updateCart = function (endPoint, params) {
        var url = this.config.url + endPoint;
        params = params.set('lang', this.config.lang);
        return this.http.post(url, params, this.config.options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(endPoint)));
    };
    ApiService.prototype.getItemMstore = function (endPoint, filter) {
        if (filter === void 0) { filter = {}; }
        var url = this.config.url + '/wp-admin/admin-ajax.php?action=mstoreapp-' + endPoint;
    ...
    ApiService.prototype.ajaxCall = function (endPoint, data) {
        if (data === void 0) { data = {}; }
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        for (var key in data) {
            if ('object' !== typeof (data[key]))
    ...
    ApiService.prototype.getPosts = function (endPoint) {
    ...
    ApiService.prototype.WCMPVendor = function (endPoint, params) {
        if (params === void 0) { params = {}; }
        var url = this.config.setUrl('GET', '/wp-json/wcmp/v1/' + endPoint + '?', params);
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(endPoint)));
    };
    ApiService.prototype.put = function (endPoint, data, params) {
        if (params === void 0) { params = {}; }
    ...
    ApiService.prototype.wcpost = function (endPoint, data, params) {
        if (params === void 0) { params = {}; }
    ...
    ApiService.prototype.getReviews = function (endPoint, filter) {
        if (filter === void 0) { filter = {}; }
        var url = this.config.setUrl('GET', '/wp-json/wc/v2/' + endPoint + '?', filter);
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(endPoint)));
    };
    ApiService.prototype.getExternalData = function (url, data) {
        if (data === void 0) { data = {}; }
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        for (var key in data) {
            if ('object' !== typeof (data[key]))
    ...
    ApiService.prototype.getAddonsList = function (endPoint, filter) {
        if (filter === void 0) { filter = {}; }
        var url = this.config.setUrl('GET', '/wp-json/wc-product-add-ons/v1/' + endPoint + '?', filter);
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(endPoint)));
    };
    ApiService.prototype.getWCFM = function (endPoint, params) {
        if (params === void 0) { params = {}; }
    ...
    ApiService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _config__WEBPACK_IMPORTED_MODULE_5__["Config"]])
    ], ApiService);
    return ApiService;
}());
...
var AppComponent = /** @class */ (function () {
    function AppComponent(nativeStorage, translateService, platform, splashScreen, statusBar, appMinimize) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.statusBar.backgroundColorByHexString('#cccccc');
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_7__["NativeStorage"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_3__["SplashScreen"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"], _ionic_native_app_minimize_ngx__WEBPACK_IMPORTED_MODULE_5__["AppMinimize"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _ionic_native_card_io_ngx__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @ionic-native/card-io/ngx */ "./node_modules/@ionic-native/card-io/ngx/index.js");
/* harmony import */ var _app_routing_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./app-routing.module */ "./src/app/app-routing.module.ts");
/* harmony import */ var _app_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./app.component */ "./src/app/app.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _app_pipes_pipe_module__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../app/pipes/pipe.module */ "./src/app/pipes/pipe.module.ts");
...
/* harmony import */ var _app_filter_filter_page__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../app/filter/filter.page */ "./src/app/filter/filter.page.ts");
/* harmony import */ var _app_home_home_page__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../app/home/home.page */ "./src/app/home/home.page.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _app_filter_filter_page__WEBPACK_IMPORTED_MODULE_22__["FilterPage"]
            ],
            entryComponents: [
                _app_filter_filter_page__WEBPACK_IMPORTED_MODULE_22__["FilterPage"]
            ],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"],
                ...
                _app_pipes_pipe_module__WEBPACK_IMPORTED_MODULE_19__["KeysPipeModule"],
            ...
            providers: [
                ...
                _ionic_native_card_io_ngx__WEBPACK_IMPORTED_MODULE_14__["CardIO"],
                ...
                _app_home_home_page__WEBPACK_IMPORTED_MODULE_23__["HomePage"],
...
var Config = /** @class */ (function () {
    function Config() {
        ...
        this.optionstwo = {};
        this.lang = 'en';
        this.url = 'https://fruitssohar.com'; // Replace URL_PLACEHOLDER with you site url (http://example.com)
        this.consumerKey = 'ck_d756d270760a3ba7d40e0342fcb05a6642653252'; //Replace CONSUMER_KEY_PLACEHOLDER with you site consumer_key
        this.consumerSecret = 'cs_fa8da452148f90ba21464e026261356b476ef792'; //Replace CONSUMER_KEY_PLACEHOLDER with you site consumer_secret
...
var Settings = /** @class */ (function () {
    function Settings(translate, api, toastController) {
        ...
        this.theme.tabBar = 'custom2';
        this.theme.header = 'custom2';
        this.theme.button = 'custom2';
    }
    Settings.prototype.ngOnInit = function () { };
    Settings.prototype.addToWishlist = function (id) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.api.postItem('add_wishlist', {
                                product_id: id
                            }).subscribe(function (res) {
                                _this.status = res;
                                console.log(_this.status);
                                _this.presentToast(_this.status.message);
                            }, function (err) {
                                console.log(err);
                            })];
                    case 1:
    ...
    Settings.prototype.removeFromWishlist = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.customer.id) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.api.postItem('remove_wishlist', {
                                product_id: id
                            }).subscribe(function (res) {
                                _this.status = res;
                                _this.presentToast(_this.status.message);
    ...
    Settings.prototype.calc = function (width) {
        this.width = width;
        if (width >= 1025) {
...
/***/ "./src/app/filter/filter.page.html":
/*!*****************************************!*\
  !*** ./src/app/filter/filter.page.html ***!
  \*****************************************/
/*! no static exports found */
...
var FilterPage = /** @class */ (function () {
    ...
    FilterPage.prototype.applyFilter = function () {
        ...
        var _loop_1 = function (key, value) {
            if (this_1.attributes[key].terms.length)
                this_1.attributes[key].terms.forEach(function (term) {
                    if (term.selected && term.selected == true) {
                        _this.filter['attributes' + i] = _this.attributes[key].id;
                        _this.filter['attribute_term' + i] = term.term_id;
                    }
                    else {
                        _this.filter['attributes' + i] = undefined;
                        _this.filter['attribute_term' + i] = undefined;
                    }
                    i++;
                });
        };
        var this_1 = this;
        for (var _i = 0, _a = Object.entries(this.attributes); _i < _a.length; _i++) {
    ...
    FilterPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-filter',
            template: __webpack_require__(/*! ./filter.page.html */ "./src/app/filter/filter.page.html"),
...
module.exports = "a.welcome-card ion-img {\n  max-height: 35vh;\n  overflow: hidden; }\n\nion-card {\n  margin: 0;\n  height: 100%; }\n\nion-card-title {\n  font-size: 40px; }\n\nion-card-header {\n  padding: 10px; }\n\nion-card-content {\n  padding: 0; }\n\nion-card-content .price {\n    padding: 0 10px 10px 10px;\n    font-weight: bold;\n    font-size: 14px; }\n\nion-card-content .price .special-price {\n      padding-left: 5px;\n      font-size: 10px;\n      font-weight: 300; }\n\nion-card-subtitle {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  font-weight: 300;\n  font-size: small; }\n\n.blocks .banner_block {\n  overflow: auto;\n  white-space: nowrap;\n  position: relative;\n  z-index: 0; }\n\n.blocks .banner_block .banner-scroll img {\n    text-decoration: none;\n    margin: 0 5px 0 5px;\n    width: 53%;\n    vertical-align: middle; }\n\n.blocks .banner_block .banner-scroll img:first-child {\n    margin: 0 5px 0 10px; }\n\n.blocks .banner_block .banner-scroll img:last-child {\n    margin: 0 10px 0 5px; }\n\n.blocks .banner_block .banner-grid img {\n    vertical-align: middle; }\n\n.blocks .banner_block .banner-grid .row.unlimited-items {\n    flex-wrap: wrap; }\n\n.blocks .banner_block .banner-grid .row.unlimited-items .col {\n    -webkit-box-flex: 0;\n            flex: none;\n    width: 50%;\n    line-height: 0;\n    padding: 5px; }\n\n.blocks .banner_block .floating-header {\n    overflow: auto;\n    white-space: nowrap;\n    z-index: 3;\n    padding-left: 30%; }\n\n.blocks .banner_block .floating-header .banner {\n      width: 90%;\n      height: auto; }\n\n@media (min-width: 481px) and (max-width: 768px) {\n      .blocks .banner_block .floating-header {\n        padding-left: 25%; } }\n\n@media (min-width: 769px) and (max-width: 1024px) {\n      .blocks .banner_block .floating-header {\n        padding-left: 20%; } }\n\n@media (min-width: 1025px) {\n      .blocks .banner_block .floating-header {\n        padding-left: 15%; } }\n\n.blocks .scrollmenu {\n  overflow: auto;\n  white-space: nowrap; }\n\n.blocks .scrollmenu a {\n  display: inline-block;\n  text-align: center;\n  padding: 14px;\n  text-decoration: none; }\n\n.blocks .left_floating {\n  padding: 0 16px;\n  z-index: -1;\n  font-size: 12px;\n  font-weight: 600;\n  letter-spacing: 1px;\n  text-transform: uppercase;\n  position: absolute;\n  top: 45%;\n  max-width: 30%;\n  width: 40%;\n  text-align: center;\n  white-space: normal; }\n\n@media (min-width: 481px) and (max-width: 768px) {\n    .blocks .left_floating {\n      max-width: 30%; } }\n\n@media (min-width: 769px) and (max-width: 1024px) {\n    .blocks .left_floating {\n      max-width: 25%; } }\n\n@media (min-width: 1025px) {\n    .blocks .left_floating {\n      max-width: 20%; } }\n\n.blocks .top_left {\n  font-size: 12px;\n  font-weight: 600;\n  letter-spacing: 1px;\n  text-transform: uppercase;\n  padding: 10px 16px; }\n\n.blocks .top_center {\n  padding: 14px 10px;\n  font-size: 12px;\n  font-weight: 600;\n  letter-spacing: 1px;\n  text-transform: uppercase;\n  text-align: center; }\n\n.blocks .top_right {\n  padding: 10px 16px;\n  font-size: 12px;\n  font-weight: 600;\n  letter-spacing: 1px;\n  text-transform: uppercase;\n  text-align: right; }\n\n.blocks .none {\n  display: none; }\n\n.blocks .block-title {\n  margin-top: 10px;\n  font-weight: 400; }\n\n.blocks .product-block {\n  overflow: auto;\n  white-space: nowrap;\n  position: relative;\n  z-index: 0; }\n\n.blocks .product-block .product-scroll {\n    padding-bottom: 5px; }\n\n.blocks .product-block .product-scroll .scroller {\n      padding: 0px 4px 15px 4px;\n      overflow: auto;\n      white-space: nowrap; }\n\n.blocks .product-block .product-scroll .scroller h5 {\n        margin: 0;\n        border-radius: 3px;\n        padding: 6px;\n        font-size: 12px;\n        text-transform: capitalize;\n        text-overflow: ellipsis;\n        overflow: hidden;\n        font-weight: 400; }\n\n.blocks .product-block .product-scroll .scroller .product-item {\n        display: inline-block;\n        text-decoration: none;\n        width: 42%;\n        padding: 0px 5px 0px 5px; }\n\n@media (min-width: 481px) and (max-width: 768px) {\n        .blocks .product-block .product-scroll .scroller .product-item {\n          width: 33.333%; } }\n\n@media (min-width: 769px) and (max-width: 1024px) {\n        .blocks .product-block .product-scroll .scroller .product-item {\n          width: 25%; } }\n\n@media (min-width: 1025px) {\n        .blocks .product-block .product-scroll .scroller .product-item {\n          width: 20%; } }\n\n.blocks .product-block .product-scroll .scroller img {\n        height: auto;\n        width: 100%; }\n\n.blocks .product-block .product-scroll .scroller ion-card {\n        width: 100%;\n        height: 100%;\n        margin: 0; }\n\n.blocks .product-block .product-scroll .scroller ion-card-content {\n        padding: 0; }\n\n.blocks .product-block .product-scroll .scroller .price-regular {\n        font-size: 14px;\n        font-weight: 400; }\n\n.blocks .product-block .product-scroll .scroller del {\n        font-size: 12px; }\n\n.blocks .product-block .product-scroll .scroller ion-label {\n        margin: 0;\n        padding: 0 6px 6px 6px; }\n\n.blocks .product-block .product-scroll .floating-header {\n      overflow: auto;\n      white-space: nowrap;\n      z-index: 3;\n      padding-left: 30%; }\n\n.blocks .product-block .product-scroll .floating-header .banner {\n        width: 90%;\n        height: auto; }\n\n.blocks .product-block .product-grid .wishlist-button-grid1 {\n    position: absolute;\n    top: 2px;\n    right: 20px;\n    font-size: 2em;\n    margin: 0.4rem -5px;\n    color: #f44336; }\n\n.blocks .product-block .product-grid .wishlist-button-grid2 {\n    position: absolute;\n    top: 2px;\n    right: 20px;\n    font-size: 2em;\n    margin: 0.4rem -5px;\n    color: #444; }\n\n.blocks .product-block .product-grid ion-row {\n    margin: 0;\n    padding: 0 0 0 5px; }\n\n.blocks .product-block .product-grid ion-col {\n    margin: 0;\n    padding: 5px 5px 0 0; }\n\n.blocks .product-block .product-grid ion-card {\n    position: relative;\n    text-align: center;\n    margin: 0;\n    width: 100%; }\n\n.blocks .product-block .product-grid ion-card img {\n      width: 100%;\n      height: 100%;\n      margin: auto;\n      padding: 0; }\n\n.blocks .product-block .product-grid ion-card ion-card-content {\n      padding: 0px; }\n\n.blocks .product-block .product-grid .card-title {\n    position: absolute;\n    top: 80%;\n    font-size: 12px;\n    width: 100%;\n    font-weight: 500; }\n\n.blocks .product-block .product-grid .card-subtitle {\n    font-size: 1.0em;\n    position: absolute;\n    top: 52%;\n    width: 100%; }\n\n.blocks .product-block .product-grid .card-name {\n    width: 144px;\n    margin: auto; }\n\n.blocks .product-block .product-grid .card-name ion-label {\n      margin: 8px 0;\n      height: 20px;\n      white-space: no-wrap;\n      font-size: 13px; }\n\n.blocks .product-block .product-grid .label {\n    margin-bottom: 10px;\n    margin-top: 5px; }\n\n.blocks .product-block .product-grid .price-delete {\n    margin: 0 7.5px;\n    font-size: 12px; }\n\n.blocks .product-block .product-grid .price-regular {\n    margin: 0 7.5px;\n    font-size: 14px;\n    font-weight: 400; }\n\n.blocks .product-block .product-grid .row.unlimited-items {\n    flex-wrap: wrap;\n    padding-left: 0; }\n\n.blocks .product-block .product-grid .row.unlimited-items .col {\n    -webkit-box-flex: 0;\n            flex: none;\n    width: 50%;\n    padding: 0; }\n\n.blocks .product-block .product-grid .row.unlimited-items .col:nth-child(2n+0) {\n    border-right: none; }\n\n@media (min-width: 481px) and (max-width: 768px) {\n    .blocks .product-block .product-grid .row.unlimited-items .col {\n      width: 33.333%; }\n    .blocks .product-block .product-grid .row.unlimited-items .col:nth-child(3n+0) {\n      border-right: none; } }\n\n@media (min-width: 769px) and (max-width: 1024px) {\n    .blocks .product-block .product-grid .row.unlimited-items .col {\n      width: 25%; }\n    .blocks .product-block .product-grid .row.unlimited-items .col:nth-child(4n+0) {\n      border-right: none; } }\n\n@media (min-width: 1025px) {\n    .blocks .product-block .product-grid .row.unlimited-items .col {\n      width: 20%; }\n    .blocks .product-block .product-grid .row.unlimited-items .col:nth-child(5n+0) {\n      border-right: none; } }\n\n.blocks .flash_sale .floating-header {\n  overflow: auto;\n  white-space: nowrap;\n  z-index: 3;\n  padding-left: 45% !important; }\n\n.blocks .flash_sale .left_floating {\n  padding: 0;\n  top: 15%;\n  max-width: 48%;\n  width: 48%; }\n\n.blocks .flash_sale .flash-item-name h2 {\n  padding: 0;\n  font-weight: 400;\n  font-size: 14px;\n  text-align: center;\n  margin-left: -7px;\n  margin-bottom: 8px;\n  margin-top: 0; }\n\n.blocks .flash_sale .flash-item-name h4 {\n  padding: 4px 4px 8px 4px;\n  font-size: 11px;\n  text-align: center;\n  text-transform: uppercase;\n  text-align: center; }\n\n.blocks .flash_sale .flash-item-name .day {\n  background: black;\n  color: #fff;\n  width: 25px;\n  min-width: 25px;\n  max-width: 25px;\n  height: 25px;\n  min-height: 25px;\n  max-height: 25px;\n  font-size: 10px;\n  display: -webkit-inline-box;\n  display: inline-flex;\n  margin: auto;\n  text-align: center; }\n\n.blocks .flash_sale .flash-item-name .day span {\n    margin: auto; }\n\n.blocks .category {\n  z-index: 0; }\n\n.blocks .category .floating-header {\n    overflow: auto;\n    white-space: nowrap;\n    z-index: 3;\n    padding-left: 43%; }\n\n.blocks .category .floating-header .banner {\n      width: 90%;\n      height: auto; }\n\n.blocks .category .category-slider-scroll, .blocks .category .category-scroll {\n    overflow: auto;\n    white-space: nowrap;\n    position: relative;\n    display: -webkit-box; }\n\n.blocks .category .category-slider-scroll .scrollmenu2, .blocks .category .category-scroll .scrollmenu2 {\n      margin: 0;\n      padding-bottom: 15px;\n      overflow: auto;\n      white-space: nowrap; }\n\n.blocks .category .category-slider-scroll .scrollmenu2 .none, .blocks .category .category-scroll .scrollmenu2 .none {\n        display: none; }\n\n.blocks .category .category-slider-scroll .scrollmenu2 h5, .blocks .category .category-scroll .scrollmenu2 h5 {\n        margin: 0;\n        border-radius: 3px;\n        padding: 10px 4px 0 4px;\n        font-size: 11px;\n        text-transform: capitalize;\n        overflow: hidden;\n        text-overflow: ellipsis; }\n\n.blocks .category .category-slider-scroll .scrollmenu2 .product-item, .blocks .category .category-scroll .scrollmenu2 .product-item {\n        display: inline-block;\n        text-align: center;\n        padding: 14px;\n        text-decoration: none;\n        padding: 0 10px 10px 10px;\n        width: 40%; }\n\n@media (min-width: 481px) and (max-width: 768px) {\n        .blocks .category .category-slider-scroll .scrollmenu2 .product-item, .blocks .category .category-scroll .scrollmenu2 .product-item {\n          width: 33.333%; } }\n\n@media (min-width: 769px) and (max-width: 1024px) {\n        .blocks .category .category-slider-scroll .scrollmenu2 .product-item, .blocks .category .category-scroll .scrollmenu2 .product-item {\n          width: 25%; } }\n\n@media (min-width: 1025px) {\n        .blocks .category .category-slider-scroll .scrollmenu2 .product-item, .blocks .category .category-scroll .scrollmenu2 .product-item {\n          width: 20%; } }\n\n.blocks .category .category-slider-grid h5, .blocks .category .category-grid h5 {\n    font-size: 13px; }\n\n.blocks .category .category-slider-grid ion-card-content, .blocks .category .category-grid ion-card-content {\n    padding: 0px; }\n\n.blocks .category .category-slider-grid .card-md ion-card-content, .blocks .category .category-grid .card-md ion-card-content {\n    padding: 0px; }\n\n.blocks .category .category-slider-grid .none, .blocks .category .category-grid .none {\n    display: none; }\n\n.blocks .category .category-slider-grid ion-card, .blocks .category .category-grid ion-card {\n    margin: 0px;\n    width: 100%;\n    border-radius: 0; }\n\n.blocks .category .category-slider-grid ion-card img, .blocks .category .category-grid ion-card img {\n      display: block;\n      width: 100%;\n      height: auto; }\n\n.blocks .category .category-slider-grid .row.unlimited-items, .blocks .category .category-grid .row.unlimited-items {\n    flex-wrap: wrap;\n    padding-left: 0; }\n\n.blocks .category .category-slider-grid .row.unlimited-items .col, .blocks .category .category-grid .row.unlimited-items .col {\n    -webkit-box-flex: 0;\n            flex: none;\n    padding: 0;\n    width: 50%; }\n\n.blocks .category .category-slider-grid .row.unlimited-items .col:nth-child(2n+0), .blocks .category .category-grid .row.unlimited-items .col:nth-child(2n+0) {\n    border-right: none; }\n\n@media (min-width: 481px) and (max-width: 768px) {\n    .blocks .category .category-slider-grid .row.unlimited-items .col, .blocks .category .category-grid .row.unlimited-items .col {\n      width: 33.333%; }\n    .blocks .category .category-slider-grid .row.unlimited-items .col:nth-child(3n+0), .blocks .category .category-grid .row.unlimited-items .col:nth-child(3n+0) {\n      border-right: none; } }\n\n@media (min-width: 769px) and (max-width: 1024px) {\n    .blocks .category .category-slider-grid .row.unlimited-items .col, .blocks .category .category-grid .row.unlimited-items .col {\n      width: 25%; }\n    .blocks .category .category-slider-grid .row.unlimited-items .col:nth-child(4n+0), .blocks .category .category-grid .row.unlimited-items .col:nth-child(4n+0) {\n      border-right: none; } }\n\n@media (min-width: 1025px) {\n    .blocks .category .category-slider-grid .row.unlimited-items .col, .blocks .category .category-grid .row.unlimited-items .col {\n      width: 20%; }\n    .blocks .category .category-slider-grid .row.unlimited-items .col:nth-child(5n+0), .blocks .category .category-grid .row.unlimited-items .col:nth-child(5n+0) {\n      border-right: none; } }\n\n.related-products {\n  padding-bottom: 10px; }\n\n.related-products .price {\n    padding: 0 10px 10px 10px;\n    font-weight: bold;\n    font-size: 14px; }\n\n.related-products .price .special-price {\n      padding-left: 5px;\n      font-size: 10px;\n      font-weight: 300; }\n\n.related-products .related-item-name {\n    font-weight: 400; }\n\n.related-products .scroll-related-products {\n    padding: 16px 0 16px 0;\n    overflow-y: hidden;\n    white-space: nowrap; }\n\n.related-products .scroll-related-products .product {\n      display: inline-block;\n      text-decoration: none;\n      width: 50%;\n      margin: 0 0 0 10px; }\n\n.related-products .scroll-related-products .product:last-child {\n      margin-right: 10px; }\n\n@media (min-width: 481px) and (max-width: 768px) {\n      .related-products .scroll-related-products .product {\n        width: 33.333%; } }\n\n@media (min-width: 769px) and (max-width: 1024px) {\n      .related-products .scroll-related-products .product {\n        width: 25%; } }\n\n@media (min-width: 1025px) {\n      .related-products .scroll-related-products .product {\n        width: 20%; } }\n\n.related-products .scroll-related-products ion-img {\n      height: auto;\n      width: 100%; }\n\n.related-products .scroll-related-products ion-card {\n      width: 100%;\n      height: 100%;\n      margin: 0; }\n\n.related-products .scroll-related-products .border {\n      border: 0.55px solid #f5f5f5; }\n\n.related-products ion-list-header ion-label {\n    font-weight: 600; }\n\nion-header img {\n  height: 30px;\n  width: auto; }\n\n.stock {\n  position: absolute;\n  top: -4px;\n  left: -6px;\n  width: 130px;\n  font-size: 8px;\n  margin: 15px;\n  margin-left: -39px;\n  -webkit-transform: rotate(-45deg);\n  transform: rotate(-45deg);\n  height: 19px;\n  --box-shadow: none; }\n\n.offer {\n  margin-left: 5px;\n  font-size: 12px;\n  --border-radius: 25px;\n  width: 36px;\n  min-height: 36px;\n  font-weight: 600;\n  position: absolute;\n  top: 5px;\n  left: 5px;\n  -webkit-box-shadow: none;\n  --box-shadow: none; }\n\n.inner-scroll {\n  padding-top: 0 !important;\n  margin-top: 64px !important; }\n\nion-refresher {\n  z-index: 1; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.getBlocks = function () {
        ...
        this.api.postItem('keys').subscribe(function (res) {
            ...
            _this.data.freaturedProducts = _this.data.blocks.featured;
            _this.data.onsaleProducts = _this.data.blocks.on_sale;
            _this.settings.calc(_this.platform.width());
            if (_this.settings.colWidthLatest == 4)
                _this.filter.per_page = 15;
            _this.splashScreen.hide();
            ...
            if (_this.data.blocks.user) {
                ...
                if (_this.data.blocks.user.allcaps.dc_vendor || _this.data.blocks.user.allcaps.seller || _this.data.blocks.user.allcaps.wcfm_vendor) {
                    console.log(_this.data.blocks.user.wcfm_vendor);
...
module.exports = __webpack_require__(/*! /Users/aymanelsharkawy/Programming/Projects/Ionic_sohar/src/main.ts */"./src/main.ts");
